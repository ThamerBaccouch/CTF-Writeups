...
public class EndianUtils {
    ...
    public static long readSwappedUnsignedInteger(byte[] data, int offset) {
        return (((long) (data[offset + 3] & 255)) << 24) + (4294967295L & ((long) (((data[offset + 0] & 255) << 0) + ((data[offset + 1] & 255) << 8) + ((data[offset + 2] & 255) << 16))));
    }

    public static void writeSwappedLong(byte[] data, int offset, long value) {
        data[offset + 0] = (byte) ((int) ((value >> 0) & 255));
    ...
    public static long readSwappedLong(byte[] data, int offset) {
        return (((long) readSwappedInteger(data, offset + 4)) << 32) + (4294967295L & ((long) readSwappedInteger(data, offset)));
    }
    ...
    public static long readSwappedUnsignedInteger(InputStream input) throws IOException {
        return (((long) (read(input) & 255)) << 24) + (4294967295L & ((long) (((read(input) & 255) << 0) + ((read(input) & 255) << 8) + ((read(input) & 255) << 16))));
    }

    public static void writeSwappedLong(OutputStream output, long value) throws IOException {
        output.write((byte) ((int) ((value >> 0) & 255)));
