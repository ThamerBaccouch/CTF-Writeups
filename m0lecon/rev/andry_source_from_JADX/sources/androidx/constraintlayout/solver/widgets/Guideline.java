...
public class Guideline extends ConstraintWidget {
    ...
    static /* synthetic */ class C01481 {
        ...
        static {
            ...
            try {
                f21x4c44d048[Type.RIGHT.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f21x4c44d048[Type.TOP.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f21x4c44d048[Type.BOTTOM.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f21x4c44d048[Type.BASELINE.ordinal()] = 5;
            } catch (NoSuchFieldError e5) {
            }
            try {
                f21x4c44d048[Type.CENTER.ordinal()] = 6;
    ...
    public ConstraintAnchor getAnchor(Type anchorType) {
        switch (C01481.f21x4c44d048[anchorType.ordinal()]) {
            case 1:
            case 2:
                if (this.mOrientation == 1) {
                    return this.mAnchor;
