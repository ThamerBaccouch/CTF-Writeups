...
public class ConstraintWidget {
    ...
    static /* synthetic */ class C01471 {
        ...
        static final /* synthetic */ int[] f20xdde91696;
        ...
        static {
            ...
            try {
                f20xdde91696[DimensionBehaviour.WRAP_CONTENT.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f20xdde91696[DimensionBehaviour.MATCH_PARENT.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f20xdde91696[DimensionBehaviour.MATCH_CONSTRAINT.ordinal()] = 4;
            ...
            try {
                f19x4c44d048[Type.TOP.ordinal()] = 2;
            } catch (NoSuchFieldError e6) {
            }
            try {
                f19x4c44d048[Type.RIGHT.ordinal()] = 3;
            } catch (NoSuchFieldError e7) {
            }
            try {
                f19x4c44d048[Type.BOTTOM.ordinal()] = 4;
            } catch (NoSuchFieldError e8) {
            }
            try {
                f19x4c44d048[Type.BASELINE.ordinal()] = 5;
            } catch (NoSuchFieldError e9) {
            }
            try {
                f19x4c44d048[Type.CENTER.ordinal()] = 6;
            } catch (NoSuchFieldError e10) {
            }
            try {
                f19x4c44d048[Type.CENTER_X.ordinal()] = 7;
            } catch (NoSuchFieldError e11) {
            }
            try {
                f19x4c44d048[Type.CENTER_Y.ordinal()] = 8;
            } catch (NoSuchFieldError e12) {
            }
            try {
                f19x4c44d048[Type.NONE.ordinal()] = 9;
    ...
    public void setGoneMargin(Type type, int goneMargin) {
        int i = C01471.f19x4c44d048[type.ordinal()];
        if (i == 1) {
    ...
    public ConstraintAnchor getAnchor(Type anchorType) {
        switch (C01471.f19x4c44d048[anchorType.ordinal()]) {
            case 1:
                return this.mLeft;
            case 2:
                return this.mTop;
    ...
    /* JADX WARNING: Removed duplicated region for block: B:149:0x02dd  */
    ...
    private void applyConstraints(LinearSystem system, boolean parentWrapContent, SolverVariable parentMin, SolverVariable parentMax, DimensionBehaviour dimensionBehaviour, boolean wrapContent, ConstraintAnchor beginAnchor, ConstraintAnchor endAnchor, int beginPosition, int dimension, int minDimension, int maxDimension, float bias, boolean useRatio, boolean inChain, int matchConstraintDefault, int matchMinDimension, int matchMaxDimension, float matchPercentDimension, boolean applyPosition) {
        ...
        int i7 = C01471.f20xdde91696[dimensionBehaviour.ordinal()];
