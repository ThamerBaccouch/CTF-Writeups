...
public class ConstraintAnchor {
    ...
    static /* synthetic */ class C01461 {
        ...
        static {
            ...
            try {
                f16x4c44d048[Type.LEFT.ordinal()] = 2;
            ...
            try {
                f16x4c44d048[Type.TOP.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f16x4c44d048[Type.BOTTOM.ordinal()] = 5;
            } catch (NoSuchFieldError e5) {
            }
            try {
                f16x4c44d048[Type.BASELINE.ordinal()] = 6;
    ...
    public boolean isValidConnection(ConstraintAnchor anchor) {
        ...
        if (target != type) {
            switch (C01461.f16x4c44d048[this.mType.ordinal()]) {
                case 1:
    ...
    public boolean isSnapCompatibleWith(ConstraintAnchor anchor) {
        ...
        switch (C01461.f16x4c44d048[this.mType.ordinal()]) {
            ...
            case 9:
                return false;
            case 2:
                int i = C01461.f16x4c44d048[anchor.getType().ordinal()];
                if (i == 3 || i == 7) {
                    return true;
                }
                return false;
            case 3:
                int i2 = C01461.f16x4c44d048[anchor.getType().ordinal()];
                if (i2 == 2 || i2 == 7) {
                    return true;
                }
                return false;
            case 4:
                int i3 = C01461.f16x4c44d048[anchor.getType().ordinal()];
                if (i3 == 5 || i3 == 8) {
                    return true;
                }
                return false;
            case 5:
                int i4 = C01461.f16x4c44d048[anchor.getType().ordinal()];
                if (i4 == 4 || i4 == 8) {
                    return true;
                }
                return false;
            case 7:
                int i5 = C01461.f16x4c44d048[anchor.getType().ordinal()];
                if (i5 == 2 || i5 == 3) {
                    return true;
                }
                return false;
            case 8:
                int i6 = C01461.f16x4c44d048[anchor.getType().ordinal()];
                if (i6 == 4 || i6 == 5) {
                    return true;
                }
                return false;
