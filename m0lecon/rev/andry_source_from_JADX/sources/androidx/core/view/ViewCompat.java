...
public class ViewCompat {
    private static final int[] ACCESSIBILITY_ACTIONS_RESOURCE_IDS = {C0013R.C0015id.accessibility_custom_action_0, C0013R.C0015id.accessibility_custom_action_1, C0013R.C0015id.accessibility_custom_action_2, C0013R.C0015id.accessibility_custom_action_3, C0013R.C0015id.accessibility_custom_action_4, C0013R.C0015id.accessibility_custom_action_5, C0013R.C0015id.accessibility_custom_action_6, C0013R.C0015id.accessibility_custom_action_7, C0013R.C0015id.accessibility_custom_action_8, C0013R.C0015id.accessibility_custom_action_9, C0013R.C0015id.accessibility_custom_action_10, C0013R.C0015id.accessibility_custom_action_11, C0013R.C0015id.accessibility_custom_action_12, C0013R.C0015id.accessibility_custom_action_13, C0013R.C0015id.accessibility_custom_action_14, C0013R.C0015id.accessibility_custom_action_15, C0013R.C0015id.accessibility_custom_action_16, C0013R.C0015id.accessibility_custom_action_17, C0013R.C0015id.accessibility_custom_action_18, C0013R.C0015id.accessibility_custom_action_19, C0013R.C0015id.accessibility_custom_action_20, C0013R.C0015id.accessibility_custom_action_21, C0013R.C0015id.accessibility_custom_action_22, C0013R.C0015id.accessibility_custom_action_23, C0013R.C0015id.accessibility_custom_action_24, C0013R.C0015id.accessibility_custom_action_25, C0013R.C0015id.accessibility_custom_action_26, C0013R.C0015id.accessibility_custom_action_27, C0013R.C0015id.accessibility_custom_action_28, C0013R.C0015id.accessibility_custom_action_29, C0013R.C0015id.accessibility_custom_action_30, C0013R.C0015id.accessibility_custom_action_31};
    ...
    static class UnhandledKeyEventManager {
        ...
        /* renamed from: at */
        static UnhandledKeyEventManager m13at(View root) {
            UnhandledKeyEventManager manager = (UnhandledKeyEventManager) root.getTag(C0013R.C0015id.tag_unhandled_key_event_manager);
            if (manager != null) {
                return manager;
            }
            UnhandledKeyEventManager manager2 = new UnhandledKeyEventManager();
            root.setTag(C0013R.C0015id.tag_unhandled_key_event_manager, manager2);
            return manager2;
        }
        ...
        private boolean onUnhandledKeyEvent(View v, KeyEvent event) {
            ArrayList<OnUnhandledKeyEventListenerCompat> viewListeners = (ArrayList) v.getTag(C0013R.C0015id.tag_unhandled_key_listeners);
    ...
    private static List<AccessibilityActionCompat> getActionList(View view) {
        ArrayList<AccessibilityActionCompat> actions = (ArrayList) view.getTag(C0013R.C0015id.tag_accessibility_actions);
        if (actions != null) {
            return actions;
        }
        ArrayList arrayList = new ArrayList();
        view.setTag(C0013R.C0015id.tag_accessibility_actions, arrayList);
        return arrayList;
    }
    ...
    public static void addOnUnhandledKeyEventListener(View v, final OnUnhandledKeyEventListenerCompat listener) {
        if (VERSION.SDK_INT >= 28) {
            Map map = (Map) v.getTag(C0013R.C0015id.tag_unhandled_key_listeners);
            if (map == null) {
                map = new ArrayMap();
                v.setTag(C0013R.C0015id.tag_unhandled_key_listeners, map);
            }
        ...
        ArrayList arrayList = (ArrayList) v.getTag(C0013R.C0015id.tag_unhandled_key_listeners);
        if (arrayList == null) {
            arrayList = new ArrayList();
            v.setTag(C0013R.C0015id.tag_unhandled_key_listeners, arrayList);
        }
    ...
    public static void removeOnUnhandledKeyEventListener(View v, OnUnhandledKeyEventListenerCompat listener) {
        if (VERSION.SDK_INT >= 28) {
            Map<OnUnhandledKeyEventListenerCompat, OnUnhandledKeyEventListener> viewListeners = (Map) v.getTag(C0013R.C0015id.tag_unhandled_key_listeners);
            if (viewListeners != null) {
        ...
        ArrayList<OnUnhandledKeyEventListenerCompat> viewListeners2 = (ArrayList) v.getTag(C0013R.C0015id.tag_unhandled_key_listeners);
    ...
    static boolean dispatchUnhandledKeyEventBeforeHierarchy(View root, KeyEvent evt) {
        ...
        return UnhandledKeyEventManager.m13at(root).preDispatch(evt);
    }
    ...
    static boolean dispatchUnhandledKeyEventBeforeCallback(View root, KeyEvent evt) {
        ...
        return UnhandledKeyEventManager.m13at(root).dispatch(root, evt);
    }
    ...
    private static AccessibilityViewProperty<Boolean> screenReaderFocusableProperty() {
        return new AccessibilityViewProperty<Boolean>(C0013R.C0015id.tag_screen_reader_focusable, Boolean.class, 28) {
            /* access modifiers changed from: 0000 */
    ...
    private static AccessibilityViewProperty<CharSequence> paneTitleProperty() {
        return new AccessibilityViewProperty<CharSequence>(C0013R.C0015id.tag_accessibility_pane_title, CharSequence.class, 8, 28) {
            /* access modifiers changed from: 0000 */
    ...
    private static AccessibilityViewProperty<Boolean> accessibilityHeadingProperty() {
        return new AccessibilityViewProperty<Boolean>(C0013R.C0015id.tag_accessibility_heading, Boolean.class, 28) {
            /* access modifiers changed from: 0000 */
            public Boolean frameworkGet(View view) {
